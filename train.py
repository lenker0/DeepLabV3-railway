...
def visualize_train(num_epochs, train, val, title, name):
    plt.plot(num_epochs, train, label = 'Train')
    plt.plot(num_epochs, val, label = 'Val')
...
def main():
    ...
    parser.add_argument('-i', '--image_count',type=int, default=6700,
    ...
    parser.add_argument('-d', '--data_dir', default='/content/data/train_data/',
    ...
    parser.add_argument('-s', '--save_dir', default='/content/drive/MyDrive/Sber_rail_dataset/',
    ...
    for i in range(0, args.epochs):
        ...
        train_loss_history.append(train_logs[loss.__name__])
        val_loss_history.append(valid_logs[loss.__name__])

        train_iou_history.append(train_logs['iou_score']) 
        val_iou_history.append(valid_logs['iou_score'])
